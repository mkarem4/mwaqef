...
$(function() {
    ...
    // Sidebar categories
    $('.categories-title [data-action=reload]').click(function (e) {
        e.preventDefault();
    ...
    $('.sidebar-default .categories-title [data-action=reload]').click(function (e) {
        e.preventDefault();
        var block = $(this).parent().parent().parent().parent();
        $(block).block({ 
            message: '<i class="icon-spinner2 spinner"></i>',
    ...
    $('.categories-collapsed').children('.categories-content').hide();


    // Rotate icon if collapsed by default
    $('.categories-collapsed').find('[data-action=collapse]').addClass('rotate-180');


    // Collapse on click
    $('.categories-title [data-action=collapse]').click(function (e) {
        e.preventDefault();
        var $categoryCollapse = $(this).parent().parent().parent().nextAll();
        $(this).parents('.categories-title').toggleClass('categories-collapsed');
    ...
    // Sidebar categories
    $('.categories-title [data-action=close]').click(function (e) {
        e.preventDefault();
    ...
    $('.navigation').find('li').not('.active, .categories-title').has('ul').children('ul').addClass('hidden-ul');
