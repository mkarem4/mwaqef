...
$(function() {    
    ...
    function trafficSources(element, height) {
        ...
        d3.csv("assets/demo_data/dashboards/traffic_sources.csv", function (error, data) {
    ...
    function appSalesLines(element, height) {
        ...
        d3.csv("assets/demo_data/dashboards/app_sales.csv", function(error, data) {
            formatted = data;
            redraw();
        });
    ...
    function salesHeatmap() {
        ...
        d3.csv("assets/demo_data/dashboards/app_sales_heatmap.csv", function(error, data) {
    ...
    function monthlySalesArea(element, height, color) {
        ...
        d3.json("assets/demo_data/dashboards/monthly_sales.json", function (error, data) {
    ...
    function bulletChart(element, height) {
        ...
        d3.json("assets/demo_data/dashboards/bullets.json", function(error, data) {
